...
| `/admin/simulacoes-finais/[id]` | Admin | Parcial | `final_simulations`, `simulation_tax_lines` | Detalhe com dados principais, produtos, despesas, parametrização fiscal, recálculo fiscal V1, status e totais básicos. |
